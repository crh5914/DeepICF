...
def _get_train_batch_user(i):
    ...
    user_list,backet_list,num_list, item_list, labels_list = [],[],[],[],[]
    trainList = _Dataset.trainList
    if i == 0:
        begin = 0
    else:
    ...
    for idx in batch_index:
        ...
        backet_list.append(nonzero_row)
    ...
    return (user_input, backets,num_idx, item_input, labels)
